    ...
    return (
        <div className="min-h-screen bg-[#F9FAFB] ">
            ...
            <main className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-center justify-center px-6 py-8 md:py-32 gap-8 md:gap-24 ">
                {/* Left side */}
                <div className="">
                    <p className="text-[1rem] font-medium text-[#475466] mb-4 text-center">Step 8 out of 09</p>
                ...
                >
                    <div>
                        <label className="block text-[1rem] font-medium text-accent mb-2">
                            What major investments will you need to start?
                        </label>
                        <input
                            name="businessName"
                    ...
                    <div>
                        <label className="block text-[1rem] font-medium text-accent mb-2">
                          What fixed costs will you have monthly?
                        </label>
                        <input
                            name="stage"
                            value={form.stage}
                    ...
                    <div>
                        <label className="block text-[1rem] font-medium text-accent mb-2">
                           What’s your estimated startup cost range?
                        </label>
                        <input
                            name="location"
                            value={form.location}
