    ...
    return (
        <div className="min-h-screen bg-[#F9FAFB] ">
            ...
            <main className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-center justify-center px-6 pt-40 gap-24">
                {/* Left side */}
                <div className="">
                    <p className="text-[1rem] font-medium text-[#475466] mb-4 text-center">Step 7 out of 09</p>
                ...
                >
                    ...
                    <div>
                        <label className="block text-[1rem] font-medium text-accent mb-2">
                            What is your expected pricing level?
                        </label>
                        <input
                            name="stage"
                            value={form.stage}
                    ...
                    <div>
                        <label className="block text-[1rem] font-medium text-accent mb-2">
                            Will you offer free trials or samples?
                        </label>
                        <input
                            name="location"
                            value={form.location}
